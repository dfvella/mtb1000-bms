...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, LED_2_Pin|LED_1_Pin|LED_3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_2_Pin LED_1_Pin LED_3_Pin */
  GPIO_InitStruct.Pin = LED_2_Pin|LED_1_Pin|LED_3_Pin;
